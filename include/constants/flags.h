...
#define FLAG_UNUSED_0x021    0x21 // Level Cap 1 Aqua Grunt
#define FLAG_DEVON_ROCKET    0x22 // Show Devon Corp Rocket Grunts
...
#define FLAG_REGISTERED_CALVIN               TRAINER_REGISTERED_FLAGS_START
